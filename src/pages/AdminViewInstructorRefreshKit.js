...
function AdminViewInstructorRefreshKit() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axios.patch(
        `http://172.232.209.245/api/kits/${selectedProduct._id}`,
        formData,
        {
          headers: {
  ...
  return (
    <div className='container mt-4'>
      ...
      <div className='row'>
        ...
        products?.filter((items) => items?.isRefreshKit == true)?.length > 0 ? (
          products
            ?.filter(
              (items) =>
            ...
            <div className='modal-content'>
              ...
              <div className='modal-body'>
                ...
                {modalType === 'delete' && (
                  <div>
                    <p>
                      Sei sicuro di voler eliminare il kit{' '}
...
export default AdminViewInstructorRefreshKit;
